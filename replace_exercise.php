...
try {
    ...
    // Ищем и заменяем упражнение
    $updated_exercises = array_map(function($e) use ($oldExercise, $newExercise) {
        return trim($e) == trim($oldExercise) ? trim($newExercise) : $e;
    }, $day_exercises);
