...
<body>
    ...
    <div class="main-content-ex">
        <div class="search-container">
            ...
            <input type="text" id="search-input" placeholder="Поиск..." class="search-input" autocomplete="off">
    ...
    <script>
        document.getElementById("search-input").addEventListener("input", function() {
            ...
            xhr.open("GET", "autocomplete.php?search_term=" + searchTerm, true);
            xhr.onload = function() {
                if (xhr.status === 200) {
        ...
        document.getElementById("search-button").addEventListener("click", function() {
            var searchTerm = document.getElementById("search-input").value;
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "search_exercises.php?search_term=" + searchTerm, true);
            xhr.onload = function() {
                if (xhr.status === 200) {
